...
class QuizInterface:
    def __init__(self,quiz_brain: QuizBrain):
        ...
        self.score_labal = tkinter.Label(text="Score: 0", fg='white', bg=THEME_COLOR)
        self.score_labal.grid(row=0, column=1)
        ...
        self.true_button = tkinter.Button(text = "CORRECT", highlightthickness=0,command=self.true_press)
        self.true_button.grid(row=2, column=0)

        false_logo = tkinter.PhotoImage('./images/false.png')
        self.false_button = tkinter.Button(text = "WRONG",highlightthickness=0,command=self.false_press)
